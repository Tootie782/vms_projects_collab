...
user = os.environ.get('VARIAMOS_MS_LANGUAGES_DB_USER', '')
password = os.environ.get('VARIAMOS_MS_LANGUAGES_DB_PASSWORD', '')
database = os.environ.get('VARIAMOS_MS_LANGUAGES_DB_DATABASE', '')
host = os.environ.get('VARIAMOS_MS_LANGUAGES_DB_HOST', '')
port = os.environ.get('VARIAMOS_MS_LANGUAGES_DB_PORT', '')
